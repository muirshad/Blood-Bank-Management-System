                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-dark">
                                        <span class="float-right summary_icon"> <i class="fa fa-user-friends text-info "></i></span>
                                        <h4><b>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-dark">
                                        <span class="float-right summary_icon"> <i class="fa fa-notes-medical text-info "></i></span>
                                        <h4><b>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-dark">
                                        <span class="float-right summary_icon"> <i class="fa fa-th-list text-info"></i></span>
                                        <h4><b>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body bg-warning">
                                    <div class="card-body text-dark">
                                        <span class="float-right summary_icon"> <i class="fa fa-check text-info "></i></span>
                                        <h4><b>
